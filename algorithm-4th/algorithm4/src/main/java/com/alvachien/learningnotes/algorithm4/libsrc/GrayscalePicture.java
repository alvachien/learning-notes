 ...
 * or set the color of the specified pixel. The {@link Color} objects are
 * converted
...
public final class GrayscalePicture implements ActionListener {
    ...
    /**
     * Returns the grayscale value of pixel ({@code col}, {@code row}) as a
     * {@link java.awt.Color}.
     *
    ...
    /**
     * Returns the grayscale value of pixel ({@code col}, {@code row}) as an
     * {@code int}
     * between 0 and 255.
     ...
     * @param col the column index
     * @param row the row index
     * @return the 8-bit integer representation of the grayscale value of pixel
     *         ({@code col}, {@code row})
     * @throws IllegalArgumentException unless both {@code 0 <= col < width} and
     *                                  {@code 0 <= row < height}
     */
    ...
    /**
     * Sets the color of pixel ({@code col}, {@code row}) to the given grayscale
     * value.
     *
     * @param col   the column index
     * @param row   the row index
     * @param color the color (converts to grayscale if color is not a shade of
     *              gray)
     * @throws IllegalArgumentException unless both {@code 0 <= col < width} and
     *                                  {@code 0 <= row < height}

package com.alvachien.learningnotes.algorithm4.libsrc;
 ...
 *
 * <li>Download <a href =
 * "https://introcs.cs.princeton.edu/java/stdlib/StdPicture.java">StdPicture.java</a>
 * and
 * <a href =
 * "https://introcs.cs.princeton.edu/java/stdlib/Picture.java">Picture.java</a>
 ...
 * </pre>
 * <p>
 * If you compile and execute the program, you should see a picture of a
 * mandrill
 * (a colorful monkey native to west-central Africa) in a window.
 *
 * <p>
 * <b>Anatomy of an image.</b>
 * An image is a <em>width</em>-by-<em>height</em> grid of pixels, with pixel
 * (0, 0)
 * in the upper-left corner.
 * Each pixel has a color that is represented using the <em>RGB color
 * model</em>,
 * which specifies the levels of <em>red</em> (R), <em>green</em> (G), and
 * <em>blue</em> (B)
 * on an integer scale from 0 to 255.
 *
 * <blockquote>
 * <img src = "https://introcs.cs.princeton.edu/java/stdlib/AnatomyImage.png"
 * width = 200 alt = "anatomy of an image">
 * </blockquote>
 *
 * <p>
 ...
 * </ul>
 * <p>
 * The first method gets the alpha component of pixel (<em>col</em>,
 * <em>row</em>).
 ...
 * Note that some file format (such as JPEG and BMP) do not support
 * transparency.
...
public final class StdPicture {
     ...
     * @throws IllegalArgumentException unless both {@code 0 <= col < width} and
     *                                  {@code 0 <= row < height}
     * @throws IllegalArgumentException unless {@code 0 <= r < 256},
     *                                  {@code 0 <= g < 256},
     *                                  and {@code 0 <= b < 256}.
     */
     ...
     * @throws IllegalArgumentException unless both {@code 0 <= col < width} and
     *                                  {@code 0 <= row < height}
     * @throws IllegalArgumentException unless {@code 0 <= a < 256},
     *                                  {@code 0 <= r < 256},
     *                                  {@code 0 <= g < 256}, and
     *                                  {@code 0 <= b < 256}.
     */
